...
from ..functions.ms_deform_attn_func_3D import ms_deform_attn_core_pytorch_3D

class MSDeformAttn_3D(nn.Module):
    ...
    def _reset_parameters(self):
        ...
        grid_init = (grid_init / grid_init.abs().max(-1, keepdim=True)[0]).view(self.n_heads, 1, 1, 3).\
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None):
        ...
        if input_padding_mask is not None:
            ...
            value = value.masked_fill(input_padding_mask[..., None].bool(), float(0))
